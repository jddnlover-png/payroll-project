...
export function DashboardTab() {
  ...
  activeFilter === 'present'
    ? dbAttendance.filter(att => !!att.check_in)
    : dbAttendance.filter(att => att.status === activeFilter);
...
const handleTableCheckIn = (employeeId: string) => {
  checkIn.mutate(employeeId);
};

const handleTableCheckOut = (employeeId: string) => {
...
if (isLoading) {
  ...
  attendance={dbAttendance ?? []}
  isLoading={isAttendanceLoading}
  onCheckIn={handleTableCheckIn}
  onCheckOut={handleTableCheckOut}
/>
